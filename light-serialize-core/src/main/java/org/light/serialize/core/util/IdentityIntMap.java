...
public class IdentityIntMap<K> {
    ...
    public IdentityIntMap(int initCapacity) {
        this(initCapacity, 0.8f);
    }

    public IdentityIntMap(int initCapacity, float loadFactor) {
        if (initCapacity < 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof IdentityIntMap)) {
            return false;
        }

        IdentityIntMap other = (IdentityIntMap) obj;
        if (other.size != size) {
            return false;
        }
